import{s as V}from"./toast-93yYkT8V.js";/* empty css               */const T={},X=typeof import.meta<"u"&&(T==null?void 0:T.VITE_API_URL)||"https://api-modular.intellaclick.com/api";function K(){const e=localStorage.getItem("token");return{"Content-Type":"application/json",...e&&{Authorization:`Bearer ${e}`}}}async function Z(e){var t,n,s,a,i;if(!e.ok){if(e.status===401){const d=await e.json().catch(()=>({error:"Authentication failed"}));if(((t=d.error)==null?void 0:t.toLowerCase().includes("token"))||((n=d.error)==null?void 0:n.toLowerCase().includes("expired"))||((s=d.error)==null?void 0:s.toLowerCase().includes("jwt"))||((a=d.message)==null?void 0:a.toLowerCase().includes("token"))||((i=d.message)==null?void 0:i.toLowerCase().includes("expired")))throw localStorage.removeItem("token"),localStorage.removeItem("refreshToken"),localStorage.removeItem("user"),alert("Your session has expired. Please log in again."),window.location.href="/login.html",new Error("Session expired. Please log in again.")}const o=await e.json().catch(()=>({error:"Request failed"}));console.error("API Error Response:",{status:e.status,statusText:e.statusText,url:e.url,errorData:o});let r=o.error||o.message||`HTTP ${e.status}`;throw typeof r!="string"&&(r=JSON.stringify(r)),(r.includes("E11000")||r.includes("duplicate key"))&&(r.includes("code_1")||r.includes("code:")?r="A class with this code already exists. Please use a different class code.":r="This record already exists in the database."),new Error(r)}return e.json()}async function p(e,t={}){const n=`${X}${e}`,s={...t,headers:{...K(),...t.headers}};try{const a=await fetch(n,s);return await Z(a)}catch(a){throw console.error(`API Error [${e}]:`,a),a}}const ee={async login(e,t){return p("/auth/login",{method:"POST",body:JSON.stringify({email:e,password:t})})},async register(e){return p("/auth/register",{method:"POST",body:JSON.stringify(e)})},async getMe(){return p("/auth/me")}},B={async getAll(e={}){const t=new URLSearchParams(e).toString();return p(`/classes${t?`?${t}`:""}`)},async getById(e){return p(`/classes/${e}`)},async create(e){return p("/classes",{method:"POST",body:JSON.stringify(e)})},async update(e,t){return p(`/classes/${e}`,{method:"PUT",body:JSON.stringify(t)})},async delete(e,t={}){const n=new URLSearchParams(t).toString();return p(`/classes/${e}${n?`?${n}`:""}`,{method:"DELETE"})},async archive(e){return p(`/classes/${e}/archive`,{method:"POST"})},async getStudents(e){return p(`/classes/${e}/students`)}};let E=null;function te(){E||(E=document.createElement("div"),E.id="toast-container",E.style.cssText=`
  ...
  `,document.body.appendChild(E))}function $(e,t="info",n=3e3){te();const s=document.createElement("div");s.className=`toast toast-${t}`;const a={success:"✓",error:"✗",warning:"⚠",info:"ℹ"},i={success:"#10B981",error:"#EF4444",warning:"#F59E0B",info:"#3B82F6"};s.innerHTML=`
    <div style="
      background: white;
      padding: 12px 20px;
      border-radius: 8px;
